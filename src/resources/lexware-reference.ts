...
export const REFERENCE_MD = [
  ...
  'MCP server. 65 tools across the domains below. Tool naming: `lexware_<action>_<resource>`.',
  '',
  '## Connection',
  '',
  ...
  '- Files: `lexware_upload_file`, `lexware_download_file`,',
  ...
  '## Split binaries',
  '',
  'The full server (`lexware-mcp-server`) exposes all 65 tools. Lean split entry points group',
